  ...
  return (
    <section className="mb-8">
      ...
      {education.map((edu, index) => (
        <div key={index} className="relative pl-8 pb-8 last:pb-0 border-l-2 border-slate-200 last:border-transparent before:content-[''] before:absolute before:-left-1.75 before:top-0 before:size-3 before:rounded-full before:bg-violet-600 before:border-2 before:border-white">
